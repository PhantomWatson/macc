...
$config = [
    ...
    'App' => [
        ...
        'fullBaseUrl' => env('FULL_BASE_URL', 'https://members.munciearts.org'),
        'imageBaseUrl' => 'img/',
        'cssBaseUrl' => 'css/',
        'jsBaseUrl' => 'js/',
        'paths' => [
    ...
    'Email' => [
        'default' => [
            ...
            'headerCharset' => 'utf-8',
            'emailFormat' => 'both',
            'from' => ['noreply@munciearts.org' => 'Muncie Arts and Culture Council'],
            'sender' => ['noreply@munciearts.org' => 'Muncie Arts and Culture Council'],
            'returnPath' => 'noreply@munciearts.org'
        ],
    ],
    ...
    'admin_email' => 'graham@phantomwatson.com',
    'cookie_key' => env('COOKIE_KEY'),
    'mailChimpApiKey' => env('MAILCHIMP_API_KEY'),
    'mailChimpListId' => 'e358f37a8c',
    'forceSSL' => true,
    'Imagine' => [
        'salt' => env('IMAGINE_SALT')
    ],
    'upload_verify_token' => env('UPLOAD_VERIFY_TOKEN'),
    'maxPicturesPerUser' => 10,
    'newMemberAlertRecipients' => [
        'info@munciearts.org'
    ],
